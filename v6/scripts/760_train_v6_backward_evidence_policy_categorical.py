#!/usr/bin/env python3
"""Train matched backward evidence controls with explicit categorical actions."""
...
def main() -> None:
    ...
    allowed_protocols = {"dagig_v6_backward_evidence_explicit_categorical_actions_v1"}
