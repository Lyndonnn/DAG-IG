#!/usr/bin/env python3
"""Train categorical evidence controls with deterministic policy logits."""
...
def main() -> None:
    ...
    allowed_protocols = {"dagig_v6_backward_evidence_explicit_categorical_deterministic_v2"}
