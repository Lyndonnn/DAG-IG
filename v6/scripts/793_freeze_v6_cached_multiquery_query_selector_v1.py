#!/usr/bin/env python3
"""Freeze the one-shot internal audit for the cached multi-query query selector."""
...
def main() -> None:
    ...
    result = {
        "decision": "DAGIG_V6_CACHED_MULTIQUERY_QUERY_SELECTOR_PROTOCOL_FROZEN",
        "protocol_version": "dagig_v6_cached_multiquery_query_selector_internal_v1",
        "selection_rule": "direct argmax of each frozen query posterior; fixed Q1 then Q2 tie break",
        "evaluation_unit": "118 visual parent states clustered by 40 held-out sample ids",
    ...
    output_path = output_dir / "DAGIG_V6_CACHED_MULTIQUERY_QUERY_SELECTOR_PROTOCOL_FREEZE.json"
